...
const Testmonial = () => {
  const [form1, setForm1] = useState({ name: '', testimonial: '', isValid: false });
  const [form2, setForm2] = useState({ name: '', testimonial: '', isValid: false });
  const [form3, setForm3] = useState({ name: '', testimonial: '', isValid: false });
  ...
  return (
    <div>
      ...
      <div className="testimonial-form">
        <h2>Share Your Testimonial (Form 1)</h2>
        ...
        {form1.isValid && <p className="success-message">Testimonial submitted successfully!</p>}
 
        {!form1.isValid && (
          <p className="error-message">Please fill out all fields before submitting.</p>
        )}
      </div>
 
      {/* Form 2 */}
      <div className="testimonial-form">
        <h2>Share Your Testimonial (Form 2)</h2>
        ...
        {form2.isValid && <p className="success-message">Testimonial submitted successfully!</p>}
      ...
      {/* Form 3 */}
      <div className="testimonial-form">
        <h2>Share Your Testimonial (Form 3)</h2>
